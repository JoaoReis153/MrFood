...
// UnimplementedPaymentCommandServiceServer must be embedded to have forward compatible implementations.
...
// UnimplementedPaymentQueryServiceServer must be embedded to have forward compatible implementations.
...
func (UnimplementedPaymentQueryServiceServer) GetReceiptsByUser(context.Context, *ReceiptRequest) (*GetReceiptResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetReceiptsByUser not implemented")
}
...
// UnimplementedPaymentToNotificationServiceServer must be embedded to have forward compatible implementations.
...
func (UnimplementedPaymentToNotificationServiceServer) SendReceipts(context.Context, *SendReceiptsRequest) (*SendReceiptsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendReceipts not implemented")
}
