...
import (
	...
	"MrFood/services/payment/internal/app"
	"MrFood/services/payment/internal/telemetry"
	"context"
	"fmt"
	"log/slog"
	"os"
...
func main() {
	...
	shutdownTelemetry, err := telemetry.Setup(ctx, "mrfood-payment", telemetry.ParseLevel(cfg.Log.Level))
	if err != nil {
