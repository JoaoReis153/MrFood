...
const (
	AuthToNotificationService_SendRegistrationEmail_FullMethodName = "/proto.AuthToNotificationService/SendRegistrationEmail"
)
...
// UnimplementedAuthToNotificationServiceServer must be embedded to have forward compatible implementations.
...
var AuthToNotificationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.AuthToNotificationService",
